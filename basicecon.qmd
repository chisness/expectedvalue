...
\begin{equation}
\begin{split}
\mathbb{E}(\text{Basic Economy}) &= \text{Price}_{(\text{Basic})}*P(\text{Stay}) + \text{Price}_{(\text{After_Switch})}*P(\text{Switch}) \\
...
\begin{equation}
\begin{split}
\mathbb{E}(\text{Regular Economy}) &= \text{Price}_{(\text{Regular})}*P(\text{Stay}) + \text{Price}_{(\text{After_Switch})}*P(\text{Switch}) \\
&= 250*0.75 + 300*0.25 \\
&= \$262.50
\end{split}
\end{equation}
