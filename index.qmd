...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 130">
  ...
  <g transform="translate(15,20)">
    ...
    <g transform="translate(0,0)" filter="url(#shadow)">
      <text x="22" y="-5" font-family="Arial" font-size="10" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="44" height="66" rx="6" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="22" y="40" font-family="Arial" font-weight="bold" font-size="22" text-anchor="middle" fill="#e74c3c">1</text>
      <text x="22" y="85" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">Count: ${count("1a")}</text>
      <text x="22" y="98" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">${percent("1a")}</text>
    </g>
    ...
    <g transform="translate(60,0)" filter="url(#shadow)">
      ...
      <rect width="44" height="66" rx="6" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="22" y="40" font-family="Arial" font-weight="bold" font-size="22" text-anchor="middle" fill="#e74c3c">1</text>
      <text x="22" y="85" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">Count: ${count("1b")}</text>
      <text x="22" y="98" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">${percent("1b")}</text>
    </g>
    ...
    <g transform="translate(120,0)" filter="url(#shadow)">
      <text x="22" y="-5" font-family="Arial" font-size="10" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="44" height="66" rx="6" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="22" y="40" font-family="Arial" font-weight="bold" font-size="22" text-anchor="middle" fill="#e74c3c">2</text>
      <text x="22" y="85" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">Count: ${count("2")}</text>
      <text x="22" y="98" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">${percent("2")}</text>
    </g>
    ...
    <g transform="translate(180,0)" filter="url(#shadow)">
      <text x="22" y="-5" font-family="Arial" font-size="10" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="44" height="66" rx="6" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="22" y="40" font-family="Arial" font-weight="bold" font-size="22" text-anchor="middle" fill="#e74c3c">3</text>
      <text x="22" y="85" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">Count: ${count("3")}</text>
      <text x="22" y="98" font-family="Arial" font-size="10" text-anchor="middle" fill="#333333">${percent("3")}</text>
    </g>
  </g>
</svg>
`
...
chartContainer = {
  ...
  // Cards box - moved to center (right: 250px)
  const cardsBox = html`<div style="
    position: absolute; 
    top: 10px; 
    right: 250px;
  ...
  // Info box - kept at original position (right: 50px)
