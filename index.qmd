...
// Wrap the buttons in a flex container to display them inline
...
values = {
  ...
  let action = null;
  if (drawOne === "drawOne") action = "drawOne";
  if (drawTen === "drawTen") action = "drawTen";
  if (drawHundred === "drawHundred") action = "drawHundred";
  if (resetBtn === "reset") action = "reset";
...
// Show SVG with cards, counts, and percentages underneath
cardsDisplay = {
