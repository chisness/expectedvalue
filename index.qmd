...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 80">
  ...
  <g transform="translate(10,12)">
    ...
    <g transform="translate(0,0)" filter="url(#shadow)">
      <text x="14" y="-3" font-family="Arial" font-size="7" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="28" height="42" rx="4" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="14" y="26" font-family="Arial" font-weight="bold" font-size="16" text-anchor="middle" fill="#e74c3c">1</text>
      <text x="14" y="54" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">Count: ${count("1a")}</text>
      <text x="14" y="62" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">${percent("1a")}</text>
    </g>
    ...
    <g transform="translate(38,0)" filter="url(#shadow)">
      ...
      <rect width="28" height="42" rx="4" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="14" y="26" font-family="Arial" font-weight="bold" font-size="16" text-anchor="middle" fill="#e74c3c">1</text>
      <text x="14" y="54" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">Count: ${count("1b")}</text>
      <text x="14" y="62" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">${percent("1b")}</text>
    </g>
    ...
    <g transform="translate(76,0)" filter="url(#shadow)">
      <text x="14" y="-3" font-family="Arial" font-size="7" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="28" height="42" rx="4" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="14" y="26" font-family="Arial" font-weight="bold" font-size="16" text-anchor="middle" fill="#e74c3c">2</text>
      <text x="14" y="54" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">Count: ${count("2")}</text>
      <text x="14" y="62" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">${percent("2")}</text>
    </g>
    ...
    <g transform="translate(114,0)" filter="url(#shadow)">
      <text x="14" y="-3" font-family="Arial" font-size="7" text-anchor="middle" fill="#555555">P = 1/4</text>
      <rect width="28" height="42" rx="4" fill="url(#cardGradient)" stroke="#2196f3" stroke-width="1.5"/>
      <text x="14" y="26" font-family="Arial" font-weight="bold" font-size="16" text-anchor="middle" fill="#e74c3c">3</text>
      <text x="14" y="54" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">Count: ${count("3")}</text>
      <text x="14" y="62" font-family="Arial" font-size="7" text-anchor="middle" fill="#333333">${percent("3")}</text>
    </g>
  </g>
</svg>
`
